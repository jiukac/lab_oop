 ...
 * Простое приложение Swing для демонстрации алгоритма поиска пути A *. В
  * пользователю предоставляется карта, содержащая начальную и конечную точки. Пользователь
...
public class AStarApp {
    ...
    private class MapCellHandler implements MouseListener
    {
        ...
        {
            // This one we ignore. Это мы игнорируем.
        }
    ...
    Это называетсяиз потока обработчика событий Swing для обеспечения безопасности потоков.*/
